...
@Client.on_message(filters.group & filters.text & ~filters.edited & filters.incoming & ~filters.command(["song"]))
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Onwer 👨‍💼', url='t.me/master_3136')
            ],[
        ...
        buttons= [[
            InlineKeyboardButton('🤖 Updates', url='https://t.me/+PMmG2WCxQXhmODU1'),
